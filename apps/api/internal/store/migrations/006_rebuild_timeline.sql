...
('a2-s4', 'artemis-2', 'Lunar Flyby', 'flyby', 'Closest approach to the Moon at ~130 km altitude. Nearly five hours of lunar observation, photography, and far-side passage.', 4, 'Day 6', 'upcoming'),
...
('a2-m8', 'artemis-2', 'a2-s4', 'Closest Lunar Approach', 'Orion passes ~130 km above the lunar surface', '2026-04-06T18:35:00Z', NULL, 8),
...
('e002', 'artemis-2', 120,   1, 'propulsion', 'Max-Q', 'Maximum dynamic pressure on the vehicle as it accelerates through the lower atmosphere.'),
('e003', 'artemis-2', 126,   1, 'propulsion', 'SRB Separation', 'Twin solid rocket boosters separate after burning through their propellant.'),
...
('e005', 'artemis-2', 510,   1, 'propulsion', 'Core Stage MECO', 'Main engine cutoff — core stage has completed its job.'),
...
('e054', 'artemis-2', 359100, 5, 'propulsion', 'Outbound Trajectory Correction 3', 'Final approach correction burn — locking in the 130 km closest-approach altitude.'),
...
('e062', 'artemis-2', 421200, 6, 'navigation', 'Closest Lunar Approach', 'Orion reaches its minimum altitude of ~130 km above the lunar surface. The crew is closer to the Moon than any humans in over 50 years.'),
('e063', 'artemis-2', 423000, 6, 'communication', 'Loss of Signal — Far Side', 'Orion passes behind the Moon. Radio contact with Earth is lost for approximately 30 minutes.'),
...
('e108', 'artemis-2', 781200, 10, 'navigation', 'Entry Interface', 'Orion enters Earth''s atmosphere at ~40,000 km/h. Heat shield faces temperatures up to 2,800°C.'),
